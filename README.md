...
- Pick a template from `Minigames` or `Example Minigames`, you'll usually want to use `2d_game.tscn`. Right Click and create a "New Inhereted Scene".
...
Hover over them to see a description of each setting.
...
```
Most of the SFX are from the Warioware DIY in-game soundboard.
